...
class SpaceItemDecoration(private val space: Int, private var layoutManager: Int) : ItemDecoration() {
    private var endAdditionalOffset = 0

    constructor(space: Int, layoutManager: Int, endAdditionalOffset: Int) : this(space, layoutManager) {
